const K4NftCarSignatureEdition1V1 = artifacts.require("K4NftCarSignatureEdition1V1");
const MyToken = artifacts.require("MyToken")

contract('K4NftCarSignatureEdition1V1', function (accounts) {

    let instance1 = null
    let instance2 = null
    before(async () => {
        instance1 = await K4NftCarSignatureEdition1V1.new({ from: accounts[3] });
        instance2 = await MyToken.new("test", "T", 1000000000000000);
        K4NftCarSignatureEdition1V1Instance = instance1;
        MyTokenInstance = instance2
    })
    var K4NftCarSignatureEdition1V1Instance, MyTokenInstance
    ...
    it('user mints the nft by using ether', async function () {
        await K4NftCarSignatureEdition1V1Instance.safeMintUsingEther(tempUser1.tokenId, tempUser1.quantity, tempUser1.hash, tempUser1.signature, { from: wallet1.address, value: 1000 });

        const getNftBalance = await K4NftCarSignatureEdition1V1Instance.balanceOf(wallet1.address)
        const getNftOwner = await K4NftCarSignatureEdition1V1Instance.ownerOf(tempUser1.tokenId)
    ...
    it('user mints the nft by using token', async function () {
        ...
        await MyTokenInstance.approve(K4NftCarSignatureEdition1V1Instance.address, tempUser2.amount, { from: wallet2.address })
        const getTokenBalance = await MyTokenInstance.balanceOf(wallet2.address)
        await K4NftCarSignatureEdition1V1Instance.safeMintUsingToken(tempUser2.tokenId, MyTokenInstance.address, tempUser2.amount, tempUser2.quantity, tempUser2.hash, tempUser2.signature, { from: wallet2.address });
        const getNftBalance = await K4NftCarSignatureEdition1V1Instance.balanceOf(wallet2.address)
        const getNftOwner = await K4NftCarSignatureEdition1V1Instance.ownerOf(tempUser2.tokenId)
    ...
    it('owner withdraw ethers and tokens from smart contract', async function () {
        const withdraw1 = await K4NftCarSignatureEdition1V1Instance.withdraw(accounts[3], { from: accounts[3] })
        const withdraw2 = await K4NftCarSignatureEdition1V1Instance.withdrawToken(MyTokenInstance.address, accounts[3], { from: accounts[3] })
    ...
    it('if user uses the same hash and signature while minting nft using ether and token, then user will get an error', async () => {
        ...
        await MyTokenInstance.approve(K4NftCarSignatureEdition1V1Instance.address, tempUser2.amount, { from: wallet1.address })
        await K4NftCarSignatureEdition1V1Instance.safeMintUsingToken(tempUser3.tokenId, MyTokenInstance.address, tempUser4.amount, tempUser3.quantity, tempUser3.hash, tempUser3.signature, { from: wallet1.address });
        await K4NftCarSignatureEdition1V1Instance.safeMintUsingEther(tempUser3.tokenId, tempUser3.quantity, "0x3e52b3a8e4b97cc23ffbdc4c2721ae918e1d409ff2dd9e20291111acb029b216", "0x3baa2f0e2d602f3b5545862ba9b9c5eef5049082495de80797feb67f47a889146e27b85330d77e2c3c2e35aa59b8042ef3766be65c489d4931a113bb2055b68a1b", { from: wallet1.address, value: 1000 });

        try {
            await MyTokenInstance.transfer(wallet1.address, 1000)
            await MyTokenInstance.approve(K4NftCarSignatureEdition1V1Instance.address, tempUser2.amount, { from: wallet1.address })
            await K4NftCarSignatureEdition1V1Instance.safeMintUsingToken(tempUser3.tokenId, MyTokenInstance.address, tempUser4.amount, tempUser3.quantity, tempUser4.hash, tempUser4.signature, { from: wallet1.address });
    ...
    it('if user buys nft after sale ends using ether and token, then user will get an error', async () => {
        ...
        try {
            await MyTokenInstance.transfer(wallet1.address, 1000)
            await MyTokenInstance.approve(K4NftCarSignatureEdition1V1Instance.address, tempUser2.amount, { from: wallet1.address })
            // await K4NftCarSignatureEdition1V1Instance.flipSaleStatus({ from: "0x90F79bf6EB2c4f870365E785982E1f101E93b906" })
    ...
    it('if owner withdraw tokens and ethers with 0 token address , then user will get an error', async () => {
        ...
        await K4NftCarSignatureEdition1V1Instance.withdrawToken(MyTokenInstance.address, accounts[3], { from: "0x90F79bf6EB2c4f870365E785982E1f101E93b906" })
        await K4NftCarSignatureEdition1V1Instance.withdraw(accounts[3], { from: "0x90F79bf6EB2c4f870365E785982E1f101E93b906" })
        try {
            await MyTokenInstance.transfer(wallet1.address, 1000)
            await MyTokenInstance.approve(K4NftCarSignatureEdition1V1Instance.address, tempUser2.amount, { from: wallet1.address })
