...
contract K4NftCarSignatureEdition3V1 is ERC721, Ownable, ReentrancyGuard {
    uint256 private constant NFTTOTALSUPPLY = 999;
    bool public isSaleActive = true;
    uint256 private constant _CONTRACTID = 9;
    ...
    constructor()
        ERC721(
            "K4 Rally NFT Car - Signature Edition #2 - Founders Drop Edition",
            "K4CARSE"
        )
    {}

    function contractURI() public pure returns (string memory) {
        return "https://game.k4rally.io/nft/car/9/";
    }
